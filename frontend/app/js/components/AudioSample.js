class AudioSample {
  ...
  scroll() {
    ...
    if (rect.top < window.innerHeight) {
      this.canvas.style.webkitTransform = `translateY(${-(window.innerHeight - rect.top)}px)`;
      this.canvas.style.MozTransform = `translateY(${-(window.innerHeight - rect.top)}px)`;
      this.canvas.style.msTransform = `translateY(${-(window.innerHeight - rect.top)}px)`;
      this.canvas.style.OTransform = `translateY(${-(window.innerHeight - rect.top)}px)`;
